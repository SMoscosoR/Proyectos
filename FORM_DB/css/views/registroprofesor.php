...
<body>
<a href="../index.php" class = "regresar"><img class = "volver" src="../icons/flecha-hacia-atras.png" ></a>
...
if(isset($_POST["id"]) && isset($_POST["nombre"]) && isset($_POST["apellido"]) && isset($_POST["job"])) {    
    ...
    $sql = "INSERT INTO Profesor(id, name, lastname, job, enable) VALUES ($id, '$nombre', '$apellido', '$job', $enable)";
