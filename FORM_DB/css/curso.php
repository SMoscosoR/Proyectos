...
<body>
    ...
    <a href="views/registrocurso.php" class="btn btn-primary">Agregar Nuevo</a>
    <?php
        include 'db/db.php';
        ...
        <?php
            while($row = mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>{$row['enable']}</td>
                    <td>
                        <a href='views/editarcurso.php?id={$row['Id']}' class='btn btn-warning' onclick='openEditar({$row['Id']})'>
    ...
    <?php
        // Manejar la solicitud de obtener detalles del curso
            ...
            if ($result->num_rows > 0) {
                ...
                echo "
                    <div>
                        <p>ID: {$row['id']}</p>
                        <p>Nombre: {$row['name']}</p>
                        <p>Profesor: {$row['teacher']}</p>
                        <p>Estudiante: {$row['student']}</p>
